...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blogContentMarkdown: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCampaignCampaign extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subText1: Attribute.Text;
    subHeading2: Attribute.String;
    subText2: Attribute.Text;
    subHeading3: Attribute.String;
    subText3: Attribute.Text;
...
export interface ApiMentorMentor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    volunteersWith: Attribute.Text;
    organizedActions: Attribute.Text;
